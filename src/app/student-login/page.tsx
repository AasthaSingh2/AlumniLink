      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <div className="bg-accent p-3 rounded-full w-16 h-16 mx-auto mb-4">
            <GraduationCap className="h-10 w-10 text-text" />
          </div>
          <h1 className="text-2xl font-bold text-text">Student Login</h1>
          <p className="text-muted">Access mentorship and opportunities</p>
        </div>
          ...
          <CardContent>
            ...
            <div className="mt-4 text-center">
              <p className="text-sm text-muted">
                ...
                <Link href="/student-register" className="text-accent hover:underline">
                  Register here
                </Link>
              </p>
            </div>
